...
(10, (SELECT id FROM `socially`.`filters` WHERE name = 'tennis court')),
(10, (SELECT id FROM `socially`.`filters` WHERE name = 'bowling')),
(10, (SELECT id FROM `socially`.`filters` WHERE name = 'darts')),
(10, (SELECT id FROM `socially`.`filters` WHERE name = 'indoors')),
...
(11, (SELECT id FROM `socially`.`filters` WHERE name = 'indoors')),
...
(13, (SELECT id FROM `socially`.`filters` WHERE name = 'indoors')),
...
(13, (SELECT id FROM `socially`.`filters` WHERE name = 'cafe')),
(13, (SELECT id FROM `socially`.`filters` WHERE name = 'outdoor seating')),
(14, (SELECT id FROM `socially`.`filters` WHERE name = 'tennis court')),
