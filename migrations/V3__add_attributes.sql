...
ADD COLUMN `fullname` VARCHAR(45) NOT NULL,
ADD COLUMN `email` VARCHAR(45) NULL,
ADD COLUMN `password` VARCHAR(45) NULL,
ADD COLUMN `google_id` VARCHAR(45) NULL,
ADD COLUMN `profile_img_url` VARCHAR(2048) NULL;
...
ADD COLUMN `longitude` DECIMAL(10,8) NOT NULL,
ADD COLUMN `img_url` VARCHAR(2048) NULL;

ALTER TABLE `socially`.`events` 
ADD COLUMN `creator_user_id` INT NOT NULL,
ADD COLUMN `desc` LONGTEXT NOT NULL,
...
ADD COLUMN `creator_user_id` INT NOT NULL,
ADD COLUMN `img_link` VARCHAR(2048) NULL;
